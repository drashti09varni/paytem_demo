...
import App_d_1 from '../Images/APP_4/App_d_4.webp';
import rating_symbol from '../Images/rating_symbol.webp';
import { HiOutlineInformationCircle } from 'react-icons/hi';
import ad_1 from '../Images/APP_4/ad_1.webp';
import ad_2 from '../Images/APP_4/ad_2.webp';
import ad_3 from '../Images/APP_4/ad_3.webp';
...
export default function App4() {
    ...
    return <>
        ...
        <div class="min-w-screen min-h-screen flex items-center justify-center py-5">
            ...
            <div className="flex space-x-4 m-5">
                <div className="">
                    ...
                    <p className="text-[14px] text-slate-800">18.3K reviews</p>
        ...
        <div class="container m-5 rounded-xl">
            ...
            <img src={ad_3} alt="image" className="object-cover h-[270px] w-full shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] rounded-xl" />
       </div>
                    ...
                    <div className="relative h-[800px] m-3 mt-10 ">
                        ...
                        <div className=" rounded-lg shadow-lg relative flex flex-col w-full h-full bg-white ">
                            ...
                            <div className=" px-6  overflow-y-auto ">
                                ...
                                <p><br />If you like earning money online by playing games, this
                                 earns money-playing game is made for you. This fantasy 
                                 earns money online game is a fantasy game, where the users play a 
                                 simple game and get money. This make-money online game is the best game
                                  who can make money easily and make money with playing a simple fantasy game, 
                                  if you have to make money easily and make money by playing a simple fantasy
                                   game so install this free money-earning game and make money just
                                    playing a simple fantasy game.</p>
